...
class NewsDetailMainSection extends React.Component {
  constructor(props) {
    super(props);
  }
  render() {
    return (
      <div class="container sectionmain specific">
        ...
        <div class="bannersection">
          <img src="img/poster6.jpg" class="bannerimage" />
        </div>
        <h4 class="stories">  Trending </h4>
        <hr/>
        <div class="trendingpost">
          <div class="imgpart">
            <img class="trendimg" src="img/mountains-681015_1280.jpg" />
          </div>
        ...
        <div class="trendingpost">
          <div class="imgpart">
            <img class="trendimg" src="img/main1.jpg" />
          </div>
          <h3><span>Health</span></h3>
          <p> Why Didn't I Dive: MS Dhoni Opens Up About The Run-Out In 2019 World Cup Semi-Final</p>
          <h5>Srishti Magan</h5>
        ...
        <div class="trendingpost">
          <div class="imgpart">
            <img class="trendimg" src="img/sunset.jpg" />
          </div>
          <h3><span>Health</span></h3>
          <p> Why Didn't I Dive: MS Dhoni Opens Up About The Run-Out In 2019 World Cup Semi-Final</p>
          <h5>Srishti Magan</h5>
        ...
        <div class="trendingpost">
          <div class="imgpart">
            <img class="trendimg" src="img/poster2.jpg" />
          </div>
          <h3><span>Health</span></h3>
          <p> Why Didn't I Dive: MS Dhoni Opens Up About The Run-Out In 2019 World Cup Semi-Final</p>
          <h5>Srishti Magan</h5>
        ...
        <div class="trendingpost">
          <div class="imgpart">
            <img class="trendimg" src="img/news2.webp" />
          </div>
          <h3><span>Health</span></h3>
          <p> Why Didn't I Dive: MS Dhoni Opens Up About The Run-Out In 2019 World Cup Semi-Final</p>
          <h5>Srishti Magan</h5>
        ...
        <div class="trendingpost">
          <div class="imgpart">
            <img class="trendimg" src="img/news1.jpg" />
          </div>
          <h3><span>Health</span></h3>
          <p> Why Didn't I Dive: MS Dhoni Opens Up About The Run-Out In 2019 World Cup Semi-Final</p>
          <h5>Srishti Magan</h5>
