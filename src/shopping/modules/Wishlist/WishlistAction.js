...
export const AddWishlist = (id) => dispatch => {
  ...
  Axios.put(`${baseURL}/customer/wishlist/` + id, {}, { headers: { "Authorization": `Bearer ${token}` } })
    .then(res => {
...
export const deleteWish = (id) => dispatch => {
  ...
  Axios.delete(`${baseURL}/customer/wishlist/` + id, { headers: { "Authorization": `Bearer ${token}` } })
  .then(res => {
...
export const moveToCart = (id) => dispatch => {
  ...
  Axios.put(`${baseURL}/customer/wishlist/cart/${id}`,{sessionId},config)
  .then((res)=>{
