...
export default class EditBankDetail extends Component {
  ...
  onChangeList = (e) => {
    ...
    if (
      ...
      e.target.value !== this.state.countryId
    ) {
  ...
  handleAddImage = (e, picked) => {
    ...
    else this.imageButton2.current.click();
  };
  ...
  validate = () => {
    ...
    let cancelledChequeError = "";

    if (!this.state.accountHolderName.trim()) {
      accountHolderNameError = "This field cannot be blank";
    }

    if (!this.state.accountNumber.trim()) {
      accountNumberError = "This field cannot be blank";
    } else if (!/^[0-9]*$/.test(this.state.accountNumber)) {
      accountNumberError = "Please Enter Numbers Only";
    }

    if (!this.state.bankName.trim()) {
      bankNameError = "Bank cannot be blank";
    }

    if (!this.state.branch.trim()) {
      branchError = "Branch cannot be blank";
    }

    if (!this.state.ifsc.trim()) {
      ifscError = "IFSC cannot be blank";
    } else if (!/^[A-Z]{4}0[A-Z0-9]{6}$/.test(this.state.ifsc)) {
  ...
  onSubmitHandler = (e) => {
    ...
    if (isValid) {
      ...
      let data = {
        ...
        cancelledCheque: this.state.cancelledCheque
          ? this.state.cancelledCheque
          : null,
      };
      ...
      if (
        ...
        srcToFile(this.state.previewproofDoc, "new.jpeg", "image/jpeg").then(
          (file) => {
            fd.append("addressProofDocument", file);
            srcToFile(this.state.previewcCheque, "new.jpeg", "image/jpeg").then(
              (file) => {
      ...
      } else this.props.saveBankDetails(fd);
    }
  };
          ...
          <form onSubmit={this.onSubmitHandler} autoComplete="off">
            <div className="form-group row">
              <div className="col-sm-4 text-left">
                <label className="" htmlFor="accountHolderName">
                  Account Holder Name
                </label>
              </div>
            ...
            <div className="form-group row">
              ...
              <div className="col-sm-4">
                <input
                  ...
                  onChange={this.onChangeHandler}
                />
                <p style={{ color: "red" }}>{this.state.accountNumberError}</p>
              </div>
            </div>
            <div className="form-group row">
              <div className="col-sm-4 text-left">
              ...
              <div className="col-sm-4">
                <input
                  ...
                  onChange={this.onChangeHandler}
                />
                <p style={{ color: "red" }}>{this.state.bankNameError}</p>
              </div>
            </div>
            <div className="form-group row">
              <div className="col-sm-4 text-left">
            ...
            <div className="form-group row">
              <div className="col-sm-4 text-left">
                <label className="" htmlFor="stateId">
                  State
                </label>
              </div>
              <div className="col-sm-4">
            ...
            <div className="form-group row">
              <div className="col-sm-4 text-left">
                <label className="" htmlFor="cityId">
                  City
                </label>
              </div>
              <div className="col-sm-4">
            ...
            <div className="form-group row">
              <div className="col-sm-4 text-left">
                <label className="" htmlFor="businessType">
                  Buisness Type
                </label>
              </div>
              <div className="col-sm-4">
            ...
            <div className="form-group row">
              ...
              <div style={{ marginLeft: "16px" }}>
                <input
                  ...
                  className="form-control"
                  onChange={(e) => this.handleImageChange(e, "previewcCheque")}
                  ref={this.imageButton2}
                  style={{ display: "none" }}
                />
                <button
