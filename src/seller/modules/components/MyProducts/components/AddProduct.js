...
class AddProduct extends Component {
  ...
  validate = () => {
    const errors = {};
    if (this.state.name.trim() === "") errors.name = "Product name is required";
    if (this.state.originalPrice.trim() === "")
      errors.originalPrice = "MRP is required";
    if (this.state.sellingPrice === "")
      errors.sellingPrice = "selling price is required";
    else if (
      parseInt(this.state.sellingPrice) > parseInt(this.state.originalPrice)
    )
      errors.sellingPrice = "Selling price should be less than or equal to MRP";
    if (
      this.state.hsn === "" ||
      !this.props.hsnDetail.includes(parseInt(this.state.hsn))
    )
    ...
    if (
      parseInt(this.state.lowStockThreshold) >= parseInt(this.state.stock) &&
    ...
    if (this.state.internationalShippingCost.trim() === "")
      errors.internationalShippingCost =
        "international delivery charge is required";
    ...
    if (
      ...
      this.state.attributes.length !== this.props.AttributesDetails.length
    )
      errors.attributes = "All attriutes are required";
    let ps2Count = Object.keys(errors).length - psCount;
    if (this.state.images.length === 0) errors.images = "images is required";
    ...
    } else this.setState({ part1noError: false });
    if (psCount) errors.psCount = psCount;
    if (ps2Count) {
      errors.ps2Count = ps2Count;
      this.setState({ part2noError: false });
    } else this.setState({ part2noError: true });
    if (errors) this.setState({ disableButton: true });
  ...
  imageRemoveHandler = (id) => {
    let imageIndex;
    if (
      id <= parseInt(this.state.primaryImageIndex) - 1 &&
      parseInt(this.state.primaryImageIndex) != 1
    ) {
  ...
  onSubmitHandler = (e) => {
    ...
    const payload = {
      ...
      domesticWarranty: this.state.domesticWarranty
        ? parseInt(this.state.domesticWarranty)
        : null,
      internationalWarranty: this.state.internationalWarranty
        ? parseInt(this.state.internationalWarranty)
        : null,
      warrantySummary: this.state.warrantySummary
        ? this.state.warrantySummary
        : null,
      warrantyServiceType: this.state.WarrantyServiceType
        ? this.state.warrantyServiceType
        : null,
      coveredInWarranty: this.state.coveredInWarranty
        ? this.state.coveredInWarranty
        : null,
      notCoveredInWarranty: this.state.notCoveredInWarranty
        ? this.state.notCoveredInWarranty
        : null,
  ...
  AttributeAddValue = (e, key, createVariant) => {
    ...
    if (e.target.type !== "text") {
      ...
      let index = this.refs.modifierValue.options[selectedIndex].getAttribute(
        "data-tag2"
      );
      console.log(
        "selected index",
      ...
      this.setState({ attributes: res, [e.target.name]: e.target.value });
      if (createVariant) {
        let resCreate3 = this.addVariant(
          this.state.variant,
          key,
          e.target.value,
          e.target.name[0]
  ...
  createVariant = (type) => {
    ...
    this.state.attributesFilled.map((item) => {
    ...
    return (
      ...
      >
        ...
        <div style={{ background: "#00000008", padding: "10px" }}>
          <h4 style={{ fontWeight: "500", fontSize: "20px" }}>Add Product</h4>
        </div>
        <div
          style={{
            margin: "10px 15px",
          ...
          <form onSubmit={this.onSubmitHandler} style={{ padding: "2px 25px" }}>
            <div className="row spacing">
              ...
              >
                ...
                >
                  Product Photo{" "}
                  {errors.images && (
                    <span className="alert alert-danger col-auto colwidth100">
                      {errors.images}
                    </span>
                  )}
                </label>
                ...
                <center>
                  ...
                  {this.state.imgPreviewUrls
                    .slice(
                      parseInt(this.state.primaryImageIndex) - 1,
                      parseInt(this.state.primaryImageIndex)
                    )
                    .map((imagePreviewUrl, i) => {
                      return (
                        <div
                          key={`imgPreviewUrlswer${i}`}
                          style={{
                            display: "flex",
              ...
              <div className="col-auto " style={{ width: "50%" }}>
                <div className="row spacing">
                  <div className="col-auto colwidth100">
                    {errors.total && (
                      <div className="alert alert-danger col-auto colwidth100">
                        {errors.total}
                      </div>
                    )}
                    <div
                      className="row innerboxmodal"
                      ...
                      <div className="col-auto colwidth100">
                        ...
                        >
                          <span>
                            {errors.psCount > 0 ? (
                              <i
                                className="fa fa-lg fa-exclamation-circle"
                                style={{ color: "red" }}
                              ></i>
                            ) : null}
                            {this.state.part1noError ? (
                              <i
                  ...
                  <button
                    id="submitButton"
                    type="submit"
                    className="btn-block upaddattribtn"
                  ...
                  <div style={{ display: "flex" }}>
                    ...
                    ) : this.state.onSubmitactive ? (
                      <>
                        <p id="uploadProgress" style={{ color: "blue" }}>
                          saving in progress....<span></span>
                        </p>
                      </>
                    ) : (
                      ""
                    ...
                    {addProductError.status === 201 ? (
                      <Link to="/seller/dashboard/myproducts">
                        {" "}
                        Click here for Your Product Listing.
                      </Link>
                    ) : null}
                  </div>
                </div>
                ...
                <div className="row subrow">
                  <div className="col-auto colwidth50">
                    ...
                    <input
                      ...
                      onChange={this.onChangeHandler}
                      value={this.state.domesticWarranty}
                      min="0"
                    />
                  </div>
                  <div className="col-auto colwidth50">
                    ...
                    <input
                      ...
                      className="form-control"
                      onChange={this.onChangeHandler}
                      value={this.state.internationalWarranty}
                    />
                  </div>
                  <div className="col-auto colwidth50">
                    <label
                      className="mr-sm-2"
                      htmlFor="warrantySummary"
                      style={{ color: "#000" }}
                    >
                      Warranty Summary
                    </label>
                    <input
                      ...
                      className="form-control"
                      onChange={this.onChangeHandler}
                      value={this.state.warrantySummary}
                    />
                  </div>
                  <div className="col-auto colwidth50">
                    <label
                      className="mr-sm-2"
                      htmlFor="warrantyServiceType"
                      style={{ color: "#000" }}
                    >
                    ...
                    <select
                      ...
                      onChange={this.onChangeHandler}
                      value={this.state.WarrantyServiceType}
                    >
                  ...
                  <div className="col-auto colwidth50">
                    ...
                    <input
                      ...
                      className="form-control"
                      onChange={this.onChangeHandler}
                      value={this.state.coveredInWarranty}
                    />
                  </div>
                  <div className="col-auto colwidth50">
                    <label
                      className="mr-sm-2"
                      htmlFor="notCoveredInWarranty"
                      style={{ color: "#000" }}
                    >
                    ...
                    <input
                      ...
                      className="form-control"
                      onChange={this.onChangeHandler}
                      value={this.state.notCoveredInWarranty}
                    />
                  </div>
                </div>
                PRODUCT DESCRIPTION
                  ...
                  <div className="col-auto colwidth50">
                    ...
                    >
                      ...
                      <span
                        ...
                        data-toggle="tooltip"
                        title="Ideal for Refer to which gender the product would be most suitable"
                        data-placement="top"
                      >
                ...
                <div className="row subrow" stylw={{ padding: "20px" }}>
                  <div className="col-auto colwidth25">
                    <label
                      className="mr-sm-2 "
                      htmlFor="styleCode"
                      style={{ color: "#000", paddingLeft: "68px" }}
                    >
                  ...
                  <div className="col-auto colwidth50">
                    <input
                      ...
                      readOnly={this.state.type === "variant" ? true : false}
                    />
                    {errors.styleCode && (
                            ...
                            <>
                              {res.multiValue === true ? (
                                <>
                                  ...
                                  <button
                                    style={{ padding: "10px" }}
                                    onClick={this.addMoreattr}
                                    disabled={
                                      this.state.ValueCount >= res.maxValues - 1
                                    }
                                  >
                                    +
                                  </button>
                  ...
                  {errors.attributes && (
                    <div className="col-auto col-width50 alert alert-danger">
                      {errors.attributes}
                    </div>
                  )}
                </div>
            ...
            >
                ...
                <div className="col-auto colwidth100">
                  ...
                  <div className="row subrow">
                    <div className="col-auto colwidth50">
                      ...
                      />
                      {errors.hsn && (
                        <div className="alert alert-danger">{errors.hsn}</div>
                      )}
                      <Link
                        className="text-info"
                        onClick={(e) => this.openModalSection(e, "setOpenHSN")}
                      >
                        Please find Relavant Hsn Code
                      </Link>
                    </div>
                    {/* <div className="col-auto colwidth50">
                  ...
                  <div className="row subrow">
                    <div className="col-auto colwidth25">
                      ...
                      <select
                        ...
                        name="fulfillmentBy"
                        onChange={this.onChangeHandler}
                        value={this.state.fulfillmentBy}
                      >
                        <option value="select" hidden>
                          Select
                        </option>
                    ...
                    <div className="col-auto colwidth50">
                      ...
                      <input
                        ...
                        className="form-control"
                        onChange={this.onChangeHandler}
                        value={this.state.maxQuantityPerOrder}
                      />
                  ...
                  <div className="row subrow">
                      ...
                      <div className="row">
                        <div className="col-auto colwidth98">
                          <input
                            ...
                            className="form-control"
                            onChange={this.onChangeHandler}
                            value={this.state.localShippingCost}
                          />
                        </div>
                    ...
                    <div className="col-auto colwidth50">
                      <label
                        className="mr-sm-2"
                        htmlFor="zonalShippingCost"
                        style={{ color: "#000" }}
                      >
                        Zonal Delivery Charges
                        <span style={{ color: "#ff0000" }}>*</span>
                      </label>
                      <div className="row">
                        <div className="col-auto colwidth98">
                          <input
                            type="number"
                            min="0"
                            name="zonalShippingCost"
                            className="form-control"
                            onChange={this.onChangeHandler}
                            value={this.state.zonalShippingCost}
                          />
                        </div>
                        <span style={{ color: "#000000" }}>INR</span>
                      </div>
                      {errors.zonalShippingCost && (
                        <div className="alert alert-danger">
                          {errors.zonalShippingCost}
                        </div>
                      )}
                    ...
                    <div className="col-auto colwidth50">
                      <label
                        className="mr-sm-2"
                        htmlFor="internationalShippingCost"
                        style={{ color: "#000" }}
                      >
                      ...
                      <div className="row">
                        <div className="col-auto colwidth98">
                          <input
                            ...
                            className="form-control"
                            onChange={this.onChangeHandler}
                            value={this.state.internationalShippingCost}
                          />
                        </div>
                        <span style={{ color: "#000000" }}>INR</span>
                      </div>
              ...
              >
                <table>
                  ...
                  {this.props.hsnDetail
                    ? this.props.hsnDetail.map((item) => {
                        return (
                          <tr>
                            <td>{item}</td>
                            <td>
                              <button
                                className="btn btn-primary"
                                onClick={(e) => this.selectHSN(e, item)}
                              >
                                Select
                              </button>
                            </td>
            ...
            >
              <div>
                <div>
                  <p>
                    Choose at least one of the following attribute to create a
                    nwe product variant
                  </p>
                </div>
                <div></div>
                <div className="row subrow">
                  <div className="col-auto colwidth50">
                    {this.state.setOpenVariant &&
                      AttributesDetails.map((item) => {
                        return item.useToCreateVariants ? (
                          <React.Fragment>
                            <div>{item.label}</div>
                            <div className="row">
                              <div>
                                {this._renderVarient(item, this.state.variant)}
                              </div>
                              <button
                                onClick={(e) => this.createNewVariant(item)}
                              >
                                Create new
                              </button>
                            </div>
                ...
                <Link
                  className="btn btn-primary"
                  onClick={this.createProductVariant}
                >
              ...
              >
                <div className="col-auto colwidth25">
                  <label
                    ...
                    style={{ color: "#000", float: "right" }}
                  >
                    {this.state.selectedVariantItem.label}{" "}
                    <span style={{ color: "#ff0000" }}>*</span>
                  </label>
                </div>
                <div
                    ...
                    <>
                      {this.state.selectedVariantItem.multiValue === true ? (
                        <>
                            ...
                            for (let i = 0; i <= this.state.ValueCount; i++) {
                              items.push(
                                <select
                                  className="custom-select mr-sm-2"
                                  name={
                                    i + this.state.selectedVariantItem.label
                                  }
                                  ref="modifierValue"
                                  value={
                                    this.state[
                                  ...
                                  onChange={(e) =>
                                    this.AttributeAddValue(
                                      e,
                                      this.state.selectedVariantItem.key,
                                      this.state.selectedVariantItem
                                        .useToCreateVariants
                                    )
                                  }
                                >
                                  <option hidden>Select One</option>
                                  {this.state.selectedVariantItem.values.map(
                                    (value, index) => {
                                      return (
                                        <option
                                          key={
                          ...
                          <button
                            ...
                            disabled={
                              ...
                              this.state.selectedVariantItem.maxValues - 1
                            }
                          >
                            +
                          </button>
                        ...
                        <select
                          ...
                          value={
                            this.state[this.state.selectedVariantItem.label]
                          }
                          ref="modifierValue"
                          onChange={(e) =>
                            this.AttributeAddValue(
                              e,
                              this.state.selectedVariantItem.key,
                              this.state.selectedVariantItem.useToCreateVariants
                            )
                          }
                        >
                          <option hidden>Select One</option>
                          {this.state.selectedVariantItem.values.map(
                            (value, i) => {
                              return (
                                <option
                                  value={value}
                                  data-tag={this.state.selectedVariantItem.key}
                                  data-tag2={i}
                                >
                                  {value}
                                </option>
            ...
            >
              ...
              <div className="row float-right mr-3">
                <div>
                  <button
                    className="btn btn-primary"
                    onClick={() => this.variantDialog("skip")}
                  >
                    Skip
                  </button>
                </div>
                <div>
                  <button
                    ...
                    onClick={() => this.variantDialog("proceed")}
                  >
                    proceed
                  </button>
                </div>
