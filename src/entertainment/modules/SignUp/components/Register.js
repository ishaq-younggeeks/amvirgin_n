  ...
  render() {
    ...
    return (
      <div className="back">
        ...
        <div className="halfleft">
          <Link
            className="flipbutton halfright"
            id="registerButton"
        ...
        <form className="loginsignupform">
          ...
          <div className="input-field">
            <PasswordField
              toggle="#password"
              htmlFor="confirm_password-field2"
              name="password_confirmation"
              value={this.state.password}
              onChange={this.onChange}
              id="confirm_password-field2"
              eye_name="confirm_password"
        ...
        <div
          ...
          role="dialog"
          style={{ display: this.props.signuploader ? "block" : "none" }}
        >
          <div className="modal-dialog loader-modal">
            <div className="modal-content">
              <div className="modal-body text-center">
                <figure>
                  <img src="/img/loading.gif" className="pay-icon" alt="" />
                </figure>
              </div>
            </div>
          </div>
        ...
        >
          ...
          <form onSubmit={this.handleOtpSubmit}>
            <input
              ...
              placeholder="OTP"
              autoFocus
              onChange={this.handleOTPChangeRegister}
              value={this.state.otp}
              required
            />
            <button
